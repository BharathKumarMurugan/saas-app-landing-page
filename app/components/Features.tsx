              ...
              >
                <div className="w-full flex justify-start items-start">
                  <div className="-ml-3 mb-12 flex items-center justify-center flex-col">
                    ...
                    <Image src={icon} width={100} height={100} alt={title} className="size-28 object-contain" />
                  </div>
                </div>
              ...
              {details.map(({ id, icon, title }) => (
                <li key={id} className="relative pt-16 px-4 pb-14">
                  ...
                  <div className="flex items-center justify-center mx-auto mb-3 border-2 border-s2 rounded-full hover:border-s4 transition-all duration-500 shadow-500 size-20">
                    <Image src={icon} alt={title} className="size-17/20 object-contain z-20" width={100} height={100} />
                  </div>
